...
public sealed class DataShaper<TEntity> : IDataShaper<TEntity> where TEntity : class
{
    ...
    private IEnumerable<ExpandoObject> FetchData(IEnumerable<TEntity> entities, IEnumerable<PropertyInfo> requiredProperties)
    {
    ...
    private ExpandoObject FetchDataForEntity(TEntity entity, IEnumerable<PropertyInfo> requiredProperties)
    {
