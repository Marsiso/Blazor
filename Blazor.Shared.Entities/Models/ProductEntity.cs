...
public sealed class ProductEntity
{
    ...
    [MaxLength(50, ErrorMessage = "Maximum length for the product name is 50 characters"), DataType(DataType.Text, ErrorMessage = "Product name must be text value type")]
